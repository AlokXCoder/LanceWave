                    ...
                    <div className="flex flex-col items-start max-w-xs">
                        ...
                        >
                            ...
                            <span className="text-lg md:text-2xl font-bold">
                                <span className="text-blue-500 dark:text-blue-400">Lance</span>
                                <span className="text-purple-700 dark:text-purple-300">Wave</span>
                            </span>
                        </Link>
                        <p className="">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 flex-1">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-base font-semibold ">
                                {[
                                    { href: "https://www.facebook.com", icon: <FaFacebook className="text-2xl" />, label: "Facebook" },
                                    { href: "https://www.linkedin.com/in/alok-jaiswar-074683287/", icon: <FaLinkedin className="text-2xl" />, label: "LinkedIn" },
                                    { href: "https://www.instagram.com", icon: <FaInstagram className="text-2xl" />, label: "Instagram" },
                                    { href: "https://twitter.com", icon: <FaTwitter className="text-2xl" />, label: "Twitter" },
                                    { href: "https://github.com/AlokXCoder", icon: <FaGithub className="text-2xl" />, label: "GitHub" },
                                ].map(({ href, icon, label }) => (
                                    <a
                                        key={label}
                                        href={href}
            ...
            <div className="border-t py-4 px-4">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span>© AJ Enterprises Ltd. {new Date().getFullYear()}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-4 text-xl">
                        <a
                            href="https://github.com/AlokXCoder"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="GitHub"
                        ...
                        <a
                            href="https://www.linkedin.com/in/alok-jaiswar-074683287/"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
                            className="hover:text-blue-400 transition"
